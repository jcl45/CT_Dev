...
**********************************************************************************************************************************************************************
COMMAND USED FOR BULK EXPORT OF CERTS
Import-Csv .\Load1.csv -UseCulture | .\Request-Certificate.ps1 -Export -CAName "wpcai010.bskyb.com\NEW-BSKYB-ISSUING-CA01" -TemplateName "WindowsSurface" -Verbose

The CSV File needs to look like this:-

CN,SAN
UK009226280457.bskyb.com,DNS=UK009226280457.bskyb.com

After exporting delete files C:\ProgramData\Microsoft\Crypto\RSA\MachineKeys as they hold the private keys
***********************************************************************************************************************************************************************
